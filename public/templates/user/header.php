        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="user-menu">
                        <ul>
                            <li><a href="http://localhost/books/myprofile"><i class="fa fa-user"></i> Moje konto</a></li>
                            ...
                            <li><a id="logout_link"><i class="fa fa-user"></i> Wyloguj</a></li> 
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="http://localhost/books/cart">Koszyk - <span class="cart-amunt"><?php echo $cart->getPrice(); ?> zł</span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo $cart->count(); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
